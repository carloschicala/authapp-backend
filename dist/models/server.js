...
const Administrator_1 = __importDefault(require("../classes/Users/Administrator"));
class Server {
    constructor() {
        this.apiPaths = {
            users: '/api/users',
    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const role_to_save = new Role_1.default(role);
            const save = yield role_to_save.save();
    ...
    routes() {
        ...
        this.app.use(this.apiPaths.messages, message_routes_1.default);
    }
}
